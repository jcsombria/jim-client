...
//-------------------------------------------------------------- 
 ...
 private String getJmatlink(String _pathOfJimc){
	 // Modified by jchacon@bec.uned.es to add support to Mac OS X and Linux	 
	String tmpdir = getTemporalSystemDirectory().replace('\\','/');
...
//System.out.println("Extracting " + filename + " from JAR...");
//System.out.println(filename + " extracted to file:/"+tmpdir);

     ZipEntry entry2 = jar.getEntry("jmatlink/"+filename);          
     File efile = new File(new java.net.URI("file:"+tmpdir+filename));
